...
def train(hyp, opt, device, tb_writer=None):
    ...
    dataloader, dataset = create_dataloader(train_path, imgsz, batch_size, gs, opt,
                                            ...
                                            rank=rank, world_size=opt.world_size, workers=opt.workers, do_clahe=opt.clahe)
    ...
    if rank in [-1, 0]:
        ...
        testloader = create_dataloader(test_path, imgsz_test, total_batch_size, gs, opt,
                                       ...
                                       rank=-1, world_size=opt.world_size, workers=opt.workers, do_clahe=opt.clahe)[0]  # testloader
...
if __name__ == '__main__':
    ...
    parser.add_argument('--clahe', action='store_true', help='apply clahe image enhancement')
